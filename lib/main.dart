...
class Match {
  ...
  factory Match.fromJson(Map<String, dynamic> j) {
    DateTime d;
    try { d = DateTime.parse(j['date'] as String? ?? ''); } catch (_) { d = DateTime.now(); }
    return Match(
      ...
      score: j['score'] as String? ?? '0 - 0', time: j['time'] as String? ?? '',
      date: d, isLive: (j['status']?.toString() ?? '0') == '1',
...
class _RootShellState extends State<RootShell> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _tabAnim = AnimationController(vsync: this, duration: const Duration(milliseconds: 600))..forward();
    _init();
  }
...
class HomeScreen extends StatelessWidget {
  ...
  const HomeScreen({
    ...
    required this.onOpenPlayer, required this.onGoMatches, required this.onRefresh,
  });
    ...
    return CustomScrollView(
      ...
      slivers: [
        ...
        if (groupsLoading)
          ...
          ...groups.map((g) => SliverToBoxAdapter(child: _ChannelGroupRow(group: g, onOpen: onOpenPlayer))),
...
class _FeaturedCardState extends State<_FeaturedCard> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _glow = AnimationController(vsync: this, duration: const Duration(milliseconds: 2600))..repeat(reverse: true);
  }
      ...
      child: AnimatedBuilder(
        ...
        builder: (_, child) => Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(color: D.blue.withValues(alpha: 0.08 + 0.09 * _glow.value), blurRadius: 40, offset: const Offset(0, 14)),
        ...
        child: ClipRRect(
          ...
          child: Stack(children: [
            ...
            Positioned(top: -60, right: -60, child: Container(
              ...
              decoration: BoxDecoration(shape: BoxShape.circle, gradient: RadialGradient(colors: [Colors.white.withValues(alpha: 0.05), Colors.transparent])),
            )),
            Positioned(bottom: -40, left: -40, child: Container(
              width: 140, height: 140,
              decoration: BoxDecoration(shape: BoxShape.circle, gradient: RadialGradient(colors: [D.blue.withValues(alpha: 0.06), Colors.transparent])),
            )),
            Positioned.fill(child: DecoratedBox(decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(D.r24),
                ...
                child: Stack(children: [
                  Positioned.fill(child: DecoratedBox(decoration: BoxDecoration(
                    ...
                    gradient: LinearGradient(
                      ...
                      colors: [Colors.white.withValues(alpha: 0.06), Colors.transparent, Colors.black.withValues(alpha: 0.10)],
                    ),
                  ))),
                  Padding(padding: const EdgeInsets.all(D.g16), child: Center(child: _NetworkImage(url: channel.logo, w: 60, h: 60))),
  ...
  Widget build(BuildContext context) {
    ...
    return CustomScrollView(
      ...
      slivers: [
        CupertinoSliverRefreshControl(onRefresh: onRefresh),
        SliverToBoxAdapter(child: SizedBox(height: topPad + D.g8)),
        SliverToBoxAdapter(child: Padding(padding: const EdgeInsets.fromLTRB(D.g20, 0, D.g20, D.g24), child: Text('Matches', style: D.hero))),
        if (loading)
          const SliverToBoxAdapter(child: _Skeleton())
            ...
            child: BackdropFilter(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(D.rMax),
                  border: Border.all(
                    color: label == 'Today' ? D.red.withValues(alpha: 0.28) : Colors.white.withValues(alpha: 0.07),
                    width: 0.5,
                  ),
                ),
...
class _PlayerScreenState extends State<PlayerScreen> with TickerProviderStateMixin {
  ...
  Widget _infoPanel() => Container(
    decoration: const BoxDecoration(
      gradient: LinearGradient(begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [D.s1, D.bg]),
    ),
    child: SafeArea(
      top: false,
      child: Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
          Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
            Container(
              ...
              child: ClipRRect(borderRadius: BorderRadius.circular(D.r16), child: _NetworkImage(url: widget.channel.logo, w: 64, h: 64)),
            ),
    ...
    return SizedBox(
      ...
      child: Stack(alignment: Alignment.centerLeft, children: [
        ...
        Positioned(
          ...
          child: Container(
            width: 12, height: 12,
            decoration: BoxDecoration(color: Colors.white, shape: BoxShape.circle, boxShadow: [BoxShadow(color: D.blue.withValues(alpha: 0.70), blurRadius: 10, spreadRadius: 1)]),
          ),
        ),
      ]),
    );
      ...
      child: BackdropFilter(
        ...
        child: Container(
          ...
          child: Stack(alignment: Alignment.center, children: [
            Positioned.fill(child: DecoratedBox(decoration: BoxDecoration(
              shape: BoxShape.circle,
              gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [Colors.white.withValues(alpha: 0.08), Colors.transparent]),
            ))),
    ...
    child: Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
      ClipRRect(
        ...
        child: BackdropFilter(
          ...
          child: Container(
            width: 76, height: 76,
            decoration: BoxDecoration(shape: BoxShape.circle, color: Colors.white.withValues(alpha: 0.07), border: Border.all(color: Colors.white.withValues(alpha: 0.10), width: 0.5)),
    ...
    child: BackdropFilter(
      ...
      child: Container(
        ...
        child: Stack(children: [
          Positioned.fill(child: DecoratedBox(decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(D.r16),
            gradient: LinearGradient(begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Colors.white.withValues(alpha: 0.04), Colors.transparent]),
          ))),
...
class _LivePulseState extends State<_LivePulse> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _a = Tween(begin: 0.25, end: 1.0).animate(CurvedAnimation(parent: _c, curve: Curves.easeInOut));
  }
...
class _NetworkImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      width: w, height: h,
      child: Image.network(url, width: w, height: h, fit: BoxFit.contain, errorBuilder: (_, __, ___) => Icon(CupertinoIcons.tv, size: math.min(w, h) * 0.45, color: D.lbl4)),
    );
  }
}
