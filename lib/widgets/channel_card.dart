    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          gradient: isActive
              ? LinearGradient(
                  colors: [c.card, AppTheme.greenDim.withOpacity(0.3)],
            ...
            child: Row(children: [
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(
                  channel.name,
                  style: TextStyle(
                    fontSize: 12, fontWeight: FontWeight.w800, color: c.text,
                  ),
...
class _LiveDotState extends State<_LiveDot>
  ...
  Widget build(BuildContext context) => FadeTransition(
    ...
    child: Container(
      width: 6, height: 6,
      decoration: BoxDecoration(
        color: widget.active ? AppTheme.green : const Color(0xFF7A8A7A),
        shape: BoxShape.circle,
      ),
    ),
  );
