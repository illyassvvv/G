        ...
        children: [
          ...
          Positioned(
            ...
            child: _Glow(
              size: 240,
              color: dark
                  ? const Color(0xFF9D7BFF).withOpacity(0.06)
                  : const Color(0xFF9D7BFF).withOpacity(0.08),
            ),
          ),
          Positioned(
            bottom: -100,
            ...
            child: _Glow(
              size: 220,
              color: dark
                  ? const Color(0xFF18C7FF).withOpacity(0.03)
                  : const Color(0xFF18C7FF).withOpacity(0.05),
            ),
          ),
          if (useBlur)
            Positioned.fill(
              ...
              child: DecoratedBox(
                decoration: BoxDecoration(
                  gradient: RadialGradient(
                    ...
                    radius: 1.2,
                    colors: [
                      Colors.white.withOpacity(dark ? 0.02 : 0.03),
                      Colors.transparent,
                    ],
                  ),
                ),
